...
public class mainN {
    ...
    public static void main(String[] args) {
        ...
        // Fill samples
            ...
            boundaries[boundaries.length - 1] = dataset.calc.quan.classBoundupper[dataset.calc.quan.classBoundupper.length - 1];
            ...
            boundaries[boundaries.length - 1] = dataset.calc.quanC.classBoundupper[dataset.calc.quanC.classBoundupper.length - 1];
